 ...
 if (! $GLOBALS['simplified_demographics']) {
	...
	?>
		...
		<table border="0">
			...
			<tr>
				<td colspan=0><span class='required'><?php xl('Auth Required','e'); ?></span></td>
				<td class=required>:</td>
				<td colspan=2>
				  <input type="radio" name="i<?php echo $i?>auth_required" value="0" <?php if ($result3{"auth_required"} == "0") echo "checked"?> ><?php xl('No','e'); ?>
				  <input type="radio" name="i<?php echo $i?>auth_required" value="1" <?php if ($result3{"auth_required"} == "1") echo "checked"?> ><?php xl('Yes','e'); ?>
				  <input type="radio" name="i<?php echo $i?>auth_required" value="2" <?php if (($result3{"auth_required"} == "2") || (!isset($result3{"auth_required"}))) echo "checked"?> ><?php xl('Not Updated','e'); ?>
				</td>
				<td></td><td></td>
				<td colspan=2>
				</td><td></td>
